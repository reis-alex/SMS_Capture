...
harmexp = H0q(:,4:end)*satelite.state_vars(satelite.idx.velocities(10:14));
harmexp = casadi.substitute(harmexp, satelite.R0,  R);
harmexp = casadi.substitute(harmexp, satelite.state_vars(15:20),  -H00\H0q*satelite.state_vars(21:end));
harmf = casadi.Function('Harm',{satelite.state_vars([1:14 21:end])},{harmexp(1:3)});
